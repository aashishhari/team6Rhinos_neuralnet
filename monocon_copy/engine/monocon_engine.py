...
from utils.kitti_convert_utils import kitti_3d_to_file # Added by Nisan
from utils.kitti_convert_utils import kitti_file_to_3d # Added by Nisan
...
class MonoconEngine(BaseEngine):
    ...
    ## Modified by Nisan - added args to evaluate(self) using lecture code
    @torch.no_grad()
    def evaluate(self, get_metrics=True, save_dir=None, single_file=True) -> Dict[str, float]:
        ...
        for test_data in tqdm(self.test_loader, desc="Collecting Results..."):
            ...
            ## Modified by Nisan - added this from lecture
        ...
        ## Modified by Nisan - changed return (from lecture)
        return None
