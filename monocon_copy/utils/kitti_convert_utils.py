...
def kitti_3d_to_file(annos: List[List[Dict]], img_metas: List[List[Dict]], folder: str, single_file: bool = False): # Nisan: modified definition based off Joey 
    ...
    """
    # annos = annos['img_bbox']; #Nisan: Joey doesn't use this.
